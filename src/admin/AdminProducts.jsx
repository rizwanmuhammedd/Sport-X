...
//           <p className="mt-4 text-gray-300 font-medium">Loading Products...</p>
//         </div>
//       </div>
//     );
//   }
...
//           <p className="text-gray-400">Manage your football gear products</p>
//         </div>
...
//               className="block w-full pl-10 pr-3 py-3 border border-gray-600 rounded-lg bg-gray-800 placeholder-gray-400 text-white focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent shadow-sm"
//             />
//           </div>
//         </div>
...
//                   <tr key={product.id} className={`hover:bg-gray-700 transition-colors duration-200 ${index % 2 === 0 ? 'bg-gray-800' : 'bg-gray-750'}`}>
//                     {productColumns.map((column) => (
