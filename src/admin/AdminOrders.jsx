...
//     try {
//       // Method 1: Update in users endpoint (existing functionality)
...
//       // Method 2: Also update in orders endpoint for consistency
//       try {
//         // First, get the order from orders endpoint
//         const orderResponse = await fetch(`http://localhost:3000/orders/${orderId}`);
//         if (orderResponse.ok) {
//           const orderData = await orderResponse.json();
          
//           // Update the order in orders endpoint
//           const updateOrderResponse = await fetch(`http://localhost:3000/orders/${orderId}`, {
//             method: 'PUT',
//             headers: {
//               'Content-Type': 'application/json',
//             },
...
//             console.warn('Failed to update order in orders endpoint, but user data updated successfully');
//           }
//         }
//       } catch (orderUpdateError) {
//         console.warn('Orders endpoint update failed:', orderUpdateError);
//         // Don't fail the entire operation if orders endpoint fails
//       }
...
//             fetch(`http://localhost:3000/users/${orderEndpointOrder.userId}`)
...
//                 });
//               })
//               .catch(err => console.warn('Failed to fetch user for order:', err));
//           }
//         });
//       }
...
//       <div className="p-6 min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900">
//         <div className="flex h-[60vh] items-center justify-center">
//           <div className="text-center bg-red-950/50 p-8 rounded-xl border border-red-800">
...
//                                   <div 
//                                     key={item.id} 
//                                     className="bg-slate-900/50 backdrop-blur-sm border border-slate-600 p-4 rounded-lg hover:border-purple-500 transition-colors"
//                                   >
//                                     <div className="flex items-center gap-3">
