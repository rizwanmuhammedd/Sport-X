  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-60 p-2 bg-slate-800 border border-slate-700 rounded-xl text-white shadow-2xl backdrop-blur-xl"
      >
        ...
        <div className="relative z-10 p-3 sm:p-4">
          ...
          >
            <span className="text-lg sm:text-xl group-hover:scale-110 transition-transform duration-300">
              {isDark ? <Sun size={18} sm:size={20}/> : <Moon size={18} sm:size={20}/>}
            </span>
            {!collapsed && (
              <span className="text-sm font-medium">
                {isDark ? "Light Mode" : "Dark Mode"}
      ...
      {/* Spacer div to push content to the right */}
      <div className={`
        ${collapsed ? "w-0 lg:w-16" : "w-0 lg:w-72"} 
