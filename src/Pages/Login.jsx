        ...
        <div className="bg-black border border-[#222] overflow-hidden flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-2/5 h-auto min-h-[200px] md:min-h-0 bg-black flex items-center justify-center relative overflow-hidden border-b md:border-b-0 md:border-r border-[#222] py-8 md:py-0">
            <div className="text-center p-6 relative z-10">
              ...
              <h1 className="text-3xl font-ilu font-semibold text-white uppercase tracking-wider mb-2">Sport-X</h1>
              <div className="h-px w-20 mx-auto bg-[#333] mb-2"></div>
              <p className="text-[#666] text-xs uppercase tracking-widest">Premium Football Gear</p>
              <div className="mt-4 flex items-center justify-center gap-2 text-[#555] text-xs uppercase tracking-widest">
