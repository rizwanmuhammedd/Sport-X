...
//   // ── navLinks: removed About, kept Home / Shop / Contact with icons only ──
//   const navLinks = [
//     { id: "home",    label: "Home",    icon: Home,       action: handleHomeClick },
//     { id: "shop",    label: "Shop",    icon: ShoppingBag, action: () => { navigate("/more-products"); setIsMobileMenuOpen(false); } },
//     { id: "contact", label: "Contact", icon: Phone,       action: () => scrollToSection("contact") },
...
//           transition: color 0.15s ease;
//         }
//         .iLU-navicon:hover { color: var(--white); }
//         .iLU-navicon.active { color: var(--white); }
//         /* Active dot indicator */
//         .iLU-navicon.active::after {
//           content: '';
//           position: absolute;
//           bottom: 4px;
//           left: 50%;
...
//             {/* ── Desktop Nav — icons only, no text ── */}
//             <div className="hidden lg:flex items-center gap-1">
//               {navLinks.map(({ id, icon: Icon, label, action }) => (
//                 <button
//                   key={id}
//                   onClick={action}
//                   title={label}
//                   className={`iLU-navicon ${activeSection === id ? "active" : ""}`}
//                 >
...
//                     textTransform: 'uppercase', color: '#fff', marginBottom: 2
//                   }}>Welcome back</p>
//                   <p style={{
//                     fontFamily: "'Barlow', sans-serif", fontSize: 11, color: '#555',
...
//           {/* Nav links — mobile still shows icon + text */}
//           <nav className="flex-1 overflow-y-auto">
//             {navLinks.map(({ id, label, icon: Icon, action }) => (
//               <button
//                 key={id}
...
//                     <span style={{
//                       position: 'absolute', top: -6, right: -6,
//                       width: 14, height: 14, background: '#fff', color: '#000',
//                       fontSize: 8, fontWeight: 800,
//                       display: 'flex', alignItems: 'center', justifyContent: 'center',
//                       fontFamily: "'Barlow Condensed', sans-serif"
//                     }}>{wishlistCount}</span>
