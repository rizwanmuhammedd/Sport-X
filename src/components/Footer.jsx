      ...
      <div className="max-w-7xl mx-auto px-6 py-16 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="space-y-4">
          ...
          <ul className="space-y-3 text-gray-300">
            <li className="flex items-center gap-3">
              <MapPin size={20} className="text-yellow-400" /> <span>Dubai, UAE</span>
            </li>
            <li className="flex items-center gap-3">
              <Phone size={20} className="text-green-400" /> <span>+971 55 123 4567</span>
            </li>
            <li className="flex items-center gap-3">
              <Mail size={20} className="text-blue-400" /> <span>support@sportify.ae</span>
            </li>
          </ul>
        </div>
        ...
        <div className="space-y-4">
          ...
          <div className="flex gap-4">
            ...
            <a href="#" className="flex items-center justify-center w-10 h-10 bg-white/10 rounded-full hover:bg-pink-400 hover:text-gray-900 transition">
              <Instagram size={18} />
            </a>
            <a href="#" className="flex items-center justify-center w-10 h-10 bg-white/10 rounded-full hover:bg-blue-400 hover:text-gray-900 transition">
              <Linkedin size={18} />
            </a>
          </div>
        </div>
